...
import static bonesman.BonesmanMod.characterPath;
import static bonesman.BonesmanMod.makeID;

public class BonesmanCharacter extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Bonesman"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass BONESMAN_CHARACTER;
        @SpireEnum(name = "CHARACTER_LILAC_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "CHARACTER_LILAC_COLOR") @SuppressWarnings("unused")
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new BonesmanCharacter(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public BonesmanCharacter() {
        super(getNames()[0], Meta.BONESMAN_CHARACTER,
